      ...
      <div className="grid grid-cols-2 gap-2 sm:grid-cols-5 md:grid-cols-6 lg:grid-cols-8 xl:grid-cols-10">
        {collectionCards?.map((card) => (
          ...
          >
            ...
            >
              <div className="mx-auto flex w-full flex-col items-center duration-200 hover:scale-110 sm:max-w-[110px] md:max-w-[110px] lg:max-w-[110px] xl:max-w-[110px]">
                <img
                  src={card.image}
                  alt={card.name}
                ...
                />
                <h3 className="mt-0 max-w-40 truncate text-sm sm:max-w-26 md:max-w-26 lg:max-w-26 xl:max-w-26">
                  {card.name}
                </h3>
              </div>
            </HoverTooltip>
